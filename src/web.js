(function() {
  ...
  // ============================================================
  // MODULE 2b — Checkout em quiz/SPA (element_click) — QZIC-1/2/3
  // ============================================================
  ...
  // QZIC-3: InitiateCheckout uma vez por visita de pagina (guard sem reset — a SPA
  ...
  // QZIC-2: require_navigation — arma no clique e so dispara se a pagina realmente
  ...
  // QZIC-1: casa por texto visivel (OR por '|', case-insensitive).
  ...
  // QZIC-1: dispara no clique (capture-phase, antes de o builder navegar). Casa por
  ...
  function handleElementClicks(e) {
    ...
    for (var name in triggers) {
      ...
      if (t.require_navigation) armNavigationFire(fireFn);  // QZIC-2
      else fireFn();
      if (__CONFIG__.debug || getUrlParam('debug') === '1') {
  ...
  // IZZO-10: reescreve a URL da propria pagina de forma segura.
